...
import project from '../assets/pictureproject.png'
  ...
  return (
    <div className='flex flex-col items-center mt-3 lg:mt-5' id='landing-page'>
      ...
      <img
        ...
        alt='quadrilateral'
      />
      <h1 className='text-2xl sm:text-3xl lg:text-5xl text-center tracking-wide mt-4'>
      ...
      <div className='flex mt-5 justify-center'>
        <p className='mt-8 text-lg text-center text-white-500 max-w-4xl'>
          The unknown angles of a quadrilateral can be easily calculated if the other angles are
          known because the interior angles of a quadrilateral always sum up to 360°. The sum of an
          interior angle and its corresponding exterior angle is always 180.{' '}
        </p>
      </div>
