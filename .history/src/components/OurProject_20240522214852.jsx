  ...
  return (
    <div className='flex flex-col items-center mt-3 lg:mt-5' id='our-project'>
      ...
      <p className='mt-8 text-lg text-center text-white-500 max-w-4xl'>
        Aim of this project was to show visually that the sum of the interior angles of a
        quadrilateral is 360° and the sum of the exterior angles of a quadrilateral is 360°. If
        there is missing angle, we can use this property to find the measure of the missing angle.
      </p>
      <img
